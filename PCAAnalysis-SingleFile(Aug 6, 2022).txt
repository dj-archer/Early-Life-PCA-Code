...
#Use ggsave to save the PCA plots to a folder called PCA Plots (as defined in the directory)
#The file name is defined as "plotfile" which will use the file name of the data table as the pCA plot file name
...
#Generate a list of all desired PERMANOVA results
...
#This will generate a csv file with all of the PERMANOVA stats in the PERMANOVAall list and save it to a folder called PERMANOVA Files (as defined in the directory)
write.csv(PERMANOVAall, file=file.path("~/Desktop/PCAFiles/PERMANOVA Files", paste("ALLPermanovaTests","(",date,")",".csv")))
